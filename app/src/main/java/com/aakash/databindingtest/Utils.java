...
//    }
//
//    public static void adjustVolume(final Context context, final AudioManager audioManager, final PlayerView playerView, final boolean raise, boolean canBoost, boolean clear) {
...
//        if (volume != volumeMax) {
//            CustomMediaPlayerActivity.boostLevel = 0;
//        }
//
//        if (CustomMediaPlayerActivity.loudnessEnhancer == null)
//            canBoost = false;
//
//        if (volume != volumeMax || (CustomMediaPlayerActivity.boostLevel == 0 && !raise)) {
//            if (CustomMediaPlayerActivity.loudnessEnhancer != null)
//                CustomMediaPlayerActivity.loudnessEnhancer.setEnabled(false);
